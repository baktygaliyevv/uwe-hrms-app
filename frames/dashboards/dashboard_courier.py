...
class DashboardCourierFrame(tk.Frame):
    ...
    def render(self):
        ...
        tk.Label(self, text=f"Hi there, {self.app.user.first_name} {self.app.user.last_name}! You are a courier", font=self.app.title_font).grid(row=0, column=0, sticky="w")
        ...
        ManageDeliveriesFrame(self, self.app, show_back=False).grid(row=1, column=0, columnspan=2, sticky='nsew')
